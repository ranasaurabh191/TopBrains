...
public partial class AdventureWorks2025Context : DbContext
{
    ...
    public virtual DbSet<SalesRaw> SalesRaws { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=.\\SQLEXPRESS;Initial Catalog=AdventureWorks2025;Integrated Security=True;Encrypt=True;TrustServerCertificate=True");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<SalesRaw>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("Sales_Raw");
            ...
            entity.Property(e => e.SalesPerson)
                .HasMaxLength(100)
                .IsUnicode(false);
            entity.Property(e => e.UnitPrices)
                .HasMaxLength(100)
                .IsUnicode(false);
        });
